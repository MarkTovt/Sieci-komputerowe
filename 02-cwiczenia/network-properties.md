...
| ------------- |:-------------:| -----:|
|   PC 1 |  
| IP - address  | 10.0.15.4 | ip addr add {ip_adres} dev eth0 |
| MASKA  | /24 (255.255.255.0) | |
|   |  | |
| PC 2  |  | |
| IP - address  | 10.0.15.6 | ip addr add {ip_adres} dev eth0 |
| MASKA  | /24 (255.255.255.0 )| |
...
| DOWN -> Wyłączenie interfejsu sieciowego| ip link set eth0 down | |
| UP -> Włączenie interfejsu sieciowego| ip link seet eth0 up | |
| Sprawdzenie obecnych parametrów | ip addr | |
| lista wszystkich interfejsów | ip link | |
